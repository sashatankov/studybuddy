                        ...
                        <TableCell align="right" size="large">
                            <Menu alignSelf="center"
                                ...
                                items={[
                                    ...
                                    { label: "מבוא ללוגיקה", onClick: () => {this.setState(
                                        {
                                            ...
                                            exam_a_date: "30.1.2019", exam_b_date: "26.2.2019", grade: ""
                                            }
                                        )} },
                                    { label: "מבוא ללוגיקה מתמטית אוריינטציה תכנותית", onClick: () => {this.setState(
                                        {
